...
namespace IM_SYSTEM{
class UserServiceImpl : public IM_SYSTEM::UserService {
    public:
        ...
        virtual void UserRegister(::google::protobuf::RpcController* controller,
            const ::IM_SYSTEM::UserRegisterReq* request,
            ::IM_SYSTEM::UserRegisterRsp* response,
        ...
        virtual void UserLogin(::google::protobuf::RpcController* controller,
            const ::IM_SYSTEM::UserLoginReq* request,
            ::IM_SYSTEM::UserLoginRsp* response,
            ::google::protobuf::Closure* done){
            LOG_DEBUG("收到用户登录请求！");
            brpc::ClosureGuard rpc_guard(done);
            auto err_response = [this, response](const std::string &rid, 
        ...
        virtual void GetPhoneVerifyCode(::google::protobuf::RpcController* controller,
            const ::IM_SYSTEM::PhoneVerifyCodeReq* request,
            ::IM_SYSTEM::PhoneVerifyCodeRsp* response,
            ::google::protobuf::Closure* done){
        ...
        virtual void PhoneRegister(::google::protobuf::RpcController* controller,
            const ::IM_SYSTEM::PhoneRegisterReq* request,
            ::IM_SYSTEM::PhoneRegisterRsp* response,
            ::google::protobuf::Closure* done){
            LOG_DEBUG("收到手机号注册请求！");
            brpc::ClosureGuard rpc_guard(done);
            auto err_response = [this, response](const std::string &rid, 
        ...
        virtual void PhoneLogin(::google::protobuf::RpcController* controller,
            const ::IM_SYSTEM::PhoneLoginReq* request,
            ::IM_SYSTEM::PhoneLoginRsp* response,
            ::google::protobuf::Closure* done){
            LOG_DEBUG("收到手机号登录请求！");
            brpc::ClosureGuard rpc_guard(done);
            auto err_response = [this, response](const std::string &rid, 
        ...
        virtual void GetUserInfo(::google::protobuf::RpcController* controller,
            const ::IM_SYSTEM::GetUserInfoReq* request,
            ::IM_SYSTEM::GetUserInfoRsp* response,
            ::google::protobuf::Closure* done){
            ...
            if (!user->avatar_id().empty()) {
                ...
                IM_SYSTEM::FileService_Stub stub(channel.get());
                IM_SYSTEM::GetSingleFileReq req;
                IM_SYSTEM::GetSingleFileRsp rsp;
        ...
        virtual void GetMultiUserInfo(::google::protobuf::RpcController* controller,
            const ::IM_SYSTEM::GetMultiUserInfoReq* request,
            ::IM_SYSTEM::GetMultiUserInfoRsp* response,
            ::google::protobuf::Closure* done){
            ...
            IM_SYSTEM::FileService_Stub stub(channel.get());
            IM_SYSTEM::GetMultiFileReq req;
            IM_SYSTEM::GetMultiFileRsp rsp;
            req.set_request_id(request->request_id());
            for (auto &user : users) {
        ...
        virtual void SetUserAvatar(::google::protobuf::RpcController* controller,
            const ::IM_SYSTEM::SetUserAvatarReq* request,
            ::IM_SYSTEM::SetUserAvatarRsp* response,
            ::google::protobuf::Closure* done){
            ...
            IM_SYSTEM::FileService_Stub stub(channel.get());
            IM_SYSTEM::PutSingleFileReq req;
            IM_SYSTEM::PutSingleFileRsp rsp;
            req.set_request_id(request->request_id());
        ...
        virtual void SetUserNickname(::google::protobuf::RpcController* controller,
            const ::IM_SYSTEM::SetUserNicknameReq* request,
            ::IM_SYSTEM::SetUserNicknameRsp* response,
            ::google::protobuf::Closure* done){
        ...
        virtual void SetUserDescription(::google::protobuf::RpcController* controller,
            const ::IM_SYSTEM::SetUserDescriptionReq* request,
            ::IM_SYSTEM::SetUserDescriptionRsp* response,
            ::google::protobuf::Closure* done){
        ...
        virtual void SetUserPhoneNumber(::google::protobuf::RpcController* controller,
            const ::IM_SYSTEM::SetUserPhoneNumberReq* request,
            ::IM_SYSTEM::SetUserPhoneNumberRsp* response,
            ::google::protobuf::Closure* done){
