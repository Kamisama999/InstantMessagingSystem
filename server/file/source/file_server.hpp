...
namespace IM_SYSTEM{
class FileServiceImpl : public IM_SYSTEM::FileService {
    public:
        ...
        void GetSingleFile(google::protobuf::RpcController* controller,
                    const ::IM_SYSTEM::GetSingleFileReq* request,
                    ::IM_SYSTEM::GetSingleFileRsp* response,
        ...
        void GetMultiFile(google::protobuf::RpcController* controller,
                    const ::IM_SYSTEM::GetMultiFileReq* request,
                    ::IM_SYSTEM::GetMultiFileRsp* response,
                    ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            response->set_request_id(request->request_id());
        ...
        void PutSingleFile(google::protobuf::RpcController* controller,
                    const ::IM_SYSTEM::PutSingleFileReq* request,
                    ::IM_SYSTEM::PutSingleFileRsp* response,
                    ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            response->set_request_id(request->request_id());
        ...
        void PutMultiFile(google::protobuf::RpcController* controller,
                    const ::IM_SYSTEM::PutMultiFileReq* request,
                    ::IM_SYSTEM::PutMultiFileRsp* response,
                    ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            response->set_request_id(request->request_id());
            for (int i = 0; i < request->file_data_size(); i++) {
                ...
                IM_SYSTEM::FileMessageInfo *info  = response->add_file_info();
